function out=mrcmultiplysec3(datafile, mult3sectionfile)

%divides each third of 'datafile' by each corresponding third of the 3-section 'multiply3sectionfile'
%i.e., does flatfielding
%020100919pmc

subme = mrcread(mult3sectionfile); %thank goodness for that
subme=double(subme);
outfile = strcat(datafile,'.FF.mrc');
