...
if($pixtype >=0 && $pixtype<7) {
   # print "within if statement: pixtype is $pixtype; ";  --got jacked by using 'my' within the if/else blocks!
    $endi="ieee-le";
    }
else {
    die ("failed: pixtype is $pixtype, and endian is $endi");
    }
}

print "Read success: pixtype is $dtypes[$pixtype], endian is $endi\n";
#print "DEBUG: pixtype is $pixtype \n";
...
$w1=0;$w2=0;$w4=0; #only doing W3
#$w1=0;$w2=0;$w3=0; #only doing W4
