function result=mrcwrite(array,fname);
...
fout=fopen(fname,'w');
fwrite(fout,hdr(1:19),'int32');
fwrite(fout,arrmin,'float32');
fwrite(fout,arrmax,'float32');
fwrite(fout,hdr(22:end),'int32');
...
fseek(fout,1024);
result=fwrite(fout,arr,'float32');
fflush(fout);
fclose(fout);
