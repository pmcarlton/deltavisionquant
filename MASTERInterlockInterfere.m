...
%
%comparing dist. of differences between XO locations, this gives a distribution different than random CO positions...
...
intn = 4; %number of chances for an interlock
