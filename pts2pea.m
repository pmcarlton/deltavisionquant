...
p1=pea_byhand_mean(a(:,:,r1),pts,[31 31 13]);
p2=pea_byhand_mean(a(:,:,r2),pts,[31 31 13]);
...
p11=pea_byhand_mean(a(:,:,r1),pts1,[31 31 13]);
p21=pea_byhand_mean(a(:,:,r2),pts1,[31 31 13]);
p31=pea_byhand_mean(a(:,:,r3),pts1,[31 31 13]);
p12=pea_byhand_mean(a(:,:,r1),pts2,[31 31 13]);
p22=pea_byhand_mean(a(:,:,r2),pts2,[31 31 13]);
p32=pea_byhand_mean(a(:,:,r3),pts2,[31 31 13]);
...
save('-binary',strcat(fn,'.pea.oct'),'p11','p21','p31','p12','p22','p32','p','pts1','pts2','a','c4t');
imwrite(p,strcat(fn,'.pea.png'));
