function [ee,res,dapi,info]=donucl3__rgbshift(data,sheldist,thresh1,thresh2,shifts,doconvex)

%does THIRD THIRD instead of FIRST THIRD as segmentation wavelength!
